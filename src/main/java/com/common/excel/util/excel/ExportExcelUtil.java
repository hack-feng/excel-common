...
import com.common.excel.util.excel.bean.ExportExcelTheme;
import com.common.excel.util.excel.bean.ExportSheetBean;
import com.common.excel.util.excel.bean.ExportTableBean;
...
public class ExportExcelUtil {
    ...
    private static void creatMoreTableSheet(ExportSheetBean sheetBean, XSSFWorkbook workbook, int i) {
        ...
        // 设置sheet页是否加密
        if (sheetBean.getProtectSheet() != null && !"".equals(sheetBean.getProtectSheet())) {
